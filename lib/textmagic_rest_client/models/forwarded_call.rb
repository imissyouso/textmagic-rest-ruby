...
module TextMagic
  class ForwardedCall
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'callTime')
    ...
    def list_invalid_properties
      ...
      if @call_time.nil?
        invalid_properties.push('invalid value for "call_time", call_time cannot be nil.')
      end
    ...
    def hash
      [id, call_time, caller, via, receiver].hash
    end
