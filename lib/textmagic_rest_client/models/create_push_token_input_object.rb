...
module TextMagic
  class CreatePushTokenInputObject
    ...
    def list_invalid_properties
      ...
      if @push_service_type.nil?
        invalid_properties.push('invalid value for "push_service_type", push_service_type cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @push_service_type.nil?
      true
    end
    ...
    def hash
      [device_id, push_service_type].hash
    end
