...
module TextMagic
  class DoAuthInputObject
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pushServiceType')
        self.push_service_type = attributes[:'pushServiceType']
      end

      if attributes.has_key?(:'tfaCode')
        self.tfa_code = attributes[:'tfaCode']
      end

      if attributes.has_key?(:'tfaId')
        self.tfa_id = attributes[:'tfaId']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          push_service_type == o.push_service_type &&
          tfa_code == o.tfa_code &&
          tfa_id == o.tfa_id
    end
    ...
    def hash
      [username, password, app_name, app_version, device_id, push_service_type, tfa_code, tfa_id].hash
    end
