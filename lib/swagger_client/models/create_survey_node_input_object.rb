...
module SwaggerClient
  class CreateSurveyNodeInputObject
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'startNode')
        self.start_node = attributes[:'startNode']
      end
    ...
    def valid?
      node_type_validator = EnumAttributeValidator.new('String', ['a', 'q'])
    ...
    def node_type=(node_type)
      validator = EnumAttributeValidator.new('String', ['a', 'q'])
    ...
    def hash
      [node_type, label, body, start_node, send_delay].hash
    end
