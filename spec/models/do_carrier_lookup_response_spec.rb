...
# Unit tests for SwaggerClient::DoCarrierLookupResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DoCarrierLookupResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::DoCarrierLookupResponse.new
  end
  ...
  describe 'test an instance of DoCarrierLookupResponse' do
    it 'should create an instance of DoCarrierLookupResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::DoCarrierLookupResponse)
    end
  end
