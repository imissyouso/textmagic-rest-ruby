...
# Unit tests for TextMagic::GetContactsByListIdResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactsByListIdResponse' do
  before do
    # run before each test
    @instance = TextMagic::GetContactsByListIdResponse.new
  end
  ...
  describe 'test an instance of GetContactsByListIdResponse' do
    it 'should create an instance of GetContactsByListIdResponse' do
      expect(@instance).to be_instance_of(TextMagic::GetContactsByListIdResponse)
    end
  end
