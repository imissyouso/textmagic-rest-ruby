...
# Unit tests for TextMagic::GetContactNotesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContactNotesResponse' do
  before do
    # run before each test
    @instance = TextMagic::GetContactNotesResponse.new
  end
  ...
  describe 'test an instance of GetContactNotesResponse' do
    it 'should create an instance of GetContactNotesResponse' do
      expect(@instance).to be_instance_of(TextMagic::GetContactNotesResponse)
    end
  end
