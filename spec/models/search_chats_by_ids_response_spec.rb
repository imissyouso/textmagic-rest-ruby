...
# Unit tests for TextMagic::SearchChatsByIdsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SearchChatsByIdsResponse' do
  before do
    # run before each test
    @instance = TextMagic::SearchChatsByIdsResponse.new
  end
  ...
  describe 'test an instance of SearchChatsByIdsResponse' do
    it 'should create an instance of SearchChatsByIdsResponse' do
      expect(@instance).to be_instance_of(TextMagic::SearchChatsByIdsResponse)
    end
  end
