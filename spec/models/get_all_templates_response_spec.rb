...
# Unit tests for TextMagic::GetAllTemplatesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAllTemplatesResponse' do
  before do
    # run before each test
    @instance = TextMagic::GetAllTemplatesResponse.new
  end
  ...
  describe 'test an instance of GetAllTemplatesResponse' do
    it 'should create an instance of GetAllTemplatesResponse' do
      expect(@instance).to be_instance_of(TextMagic::GetAllTemplatesResponse)
    end
  end
