...
# Unit tests for SwaggerClient::SetChatStatusInputObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SetChatStatusInputObject' do
  before do
    # run before each test
    @instance = SwaggerClient::SetChatStatusInputObject.new
  end
  ...
  describe 'test an instance of SetChatStatusInputObject' do
    it 'should create an instance of SetChatStatusInputObject' do
      expect(@instance).to be_instance_of(SwaggerClient::SetChatStatusInputObject)
    end
  end
