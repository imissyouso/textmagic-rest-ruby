...
# Unit tests for TextMagic::GetAllMessageSessionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAllMessageSessionsResponse' do
  before do
    # run before each test
    @instance = TextMagic::GetAllMessageSessionsResponse.new
  end
  ...
  describe 'test an instance of GetAllMessageSessionsResponse' do
    it 'should create an instance of GetAllMessageSessionsResponse' do
      expect(@instance).to be_instance_of(TextMagic::GetAllMessageSessionsResponse)
    end
  end
