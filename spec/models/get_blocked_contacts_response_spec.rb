...
# Unit tests for TextMagic::GetBlockedContactsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetBlockedContactsResponse' do
  before do
    # run before each test
    @instance = TextMagic::GetBlockedContactsResponse.new
  end
  ...
  describe 'test an instance of GetBlockedContactsResponse' do
    it 'should create an instance of GetBlockedContactsResponse' do
      expect(@instance).to be_instance_of(TextMagic::GetBlockedContactsResponse)
    end
  end
