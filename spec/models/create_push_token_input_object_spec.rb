...
# Unit tests for TextMagic::CreatePushTokenInputObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreatePushTokenInputObject' do
  before do
    # run before each test
    @instance = TextMagic::CreatePushTokenInputObject.new
  end
  ...
  describe 'test an instance of CreatePushTokenInputObject' do
    it 'should create an instance of CreatePushTokenInputObject' do
      expect(@instance).to be_instance_of(TextMagic::CreatePushTokenInputObject)
    end
  end
