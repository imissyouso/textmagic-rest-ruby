...
# Unit tests for TextMagic::GetListsOfContactResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetListsOfContactResponse' do
  before do
    # run before each test
    @instance = TextMagic::GetListsOfContactResponse.new
  end
  ...
  describe 'test an instance of GetListsOfContactResponse' do
    it 'should create an instance of GetListsOfContactResponse' do
      expect(@instance).to be_instance_of(TextMagic::GetListsOfContactResponse)
    end
  end
