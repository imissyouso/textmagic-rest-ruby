...
# Unit tests for TextMagic::SearchContactsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SearchContactsResponse' do
  before do
    # run before each test
    @instance = TextMagic::SearchContactsResponse.new
  end
  ...
  describe 'test an instance of SearchContactsResponse' do
    it 'should create an instance of SearchContactsResponse' do
      expect(@instance).to be_instance_of(TextMagic::SearchContactsResponse)
    end
  end
