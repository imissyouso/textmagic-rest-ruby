...
# Unit tests for TextMagic::GetAllBulkSessionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetAllBulkSessionsResponse' do
  before do
    # run before each test
    @instance = TextMagic::GetAllBulkSessionsResponse.new
  end
  ...
  describe 'test an instance of GetAllBulkSessionsResponse' do
    it 'should create an instance of GetAllBulkSessionsResponse' do
      expect(@instance).to be_instance_of(TextMagic::GetAllBulkSessionsResponse)
    end
  end
