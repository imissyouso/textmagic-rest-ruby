...
# Unit tests for TextMagic::SearchTemplatesResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SearchTemplatesResponse' do
  before do
    # run before each test
    @instance = TextMagic::SearchTemplatesResponse.new
  end
  ...
  describe 'test an instance of SearchTemplatesResponse' do
    it 'should create an instance of SearchTemplatesResponse' do
      expect(@instance).to be_instance_of(TextMagic::SearchTemplatesResponse)
    end
  end
