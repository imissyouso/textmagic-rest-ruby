...
# Unit tests for TextMagic::CreateSurveyInputObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateSurveyInputObject' do
  before do
    # run before each test
    @instance = TextMagic::CreateSurveyInputObject.new
  end
  ...
  describe 'test an instance of CreateSurveyInputObject' do
    it 'should create an instance of CreateSurveyInputObject' do
      expect(@instance).to be_instance_of(TextMagic::CreateSurveyInputObject)
    end
  end
