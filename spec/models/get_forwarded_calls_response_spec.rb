...
# Unit tests for TextMagic::GetForwardedCallsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetForwardedCallsResponse' do
  before do
    # run before each test
    @instance = TextMagic::GetForwardedCallsResponse.new
  end
  ...
  describe 'test an instance of GetForwardedCallsResponse' do
    it 'should create an instance of GetForwardedCallsResponse' do
      expect(@instance).to be_instance_of(TextMagic::GetForwardedCallsResponse)
    end
  end
